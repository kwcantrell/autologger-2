...
| `POST …/local-audio-import` → **400** missing/invalid `duration_s`/empty body · **404** session · **409** rolling · **200** `{ok: true}` success (local file attach+anchor; requires `duration_s`; not YouTube) | `routers/sessions.py` |
