...
//
// Captured from a real `GET /api/transcript-generation/status (idle)` response by
...
export const transcriptGenerationStatusIdle = captured as Mutable<typeof captured>;
