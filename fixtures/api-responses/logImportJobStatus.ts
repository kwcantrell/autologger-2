...
//
// Captured from a real `GET /api/log-import/:jobId (terminal: failed download)` response by
...
const captured = {
  ...
  "lines": [
    ...
    "Failed: Spreadsheet download returned HTML instead of XLSX. Ensure the sheet is shared as anyone-with-the-link can view."
  ],
  "error": "Spreadsheet download returned HTML instead of XLSX. Ensure the sheet is shared as anyone-with-the-link can view."
} as const;

export const logImportJobStatus = captured as Mutable<typeof captured>;
