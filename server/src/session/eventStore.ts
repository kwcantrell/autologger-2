...
export class EventStore {
  ...
  deleteAutoGeneratedEvents(): number {
   ...
   * SQL predicate deleteAutoGeneratedEvents() uses (json_valid + json_type
   * '$.auto_generated' = 'true'), independent of any list page/window.
   * Read-only: no revision bump, no broadcast. */
